...
interface FurnitureGallerySectionProps {
...
// FurnitureGallerySection Component
const FurnitureGallerySection: React.FC<FurnitureGallerySectionProps> = ({
  form,
  galleryFields,
  appendGalleryImage,
  removeGalleryImage,
  ...
  return (
    <Card>
      <CardHeader className="gap-0 pb-1.5">
        ...
        <CardDescription>
          Add multiple images to showcase the furniture product.
        </CardDescription>
      </CardHeader>
