...
// BlogDetailNewsletter Component — Journal subscription CTA for blog detail pages
const BlogDetailNewsletter = () => {
  return (
    <section
      id="blog-detail-newsletter"
      aria-label="Subscribe to Liminal Journal"
      ...
      <div className="custom-container relative z-10">
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <p className="text-muted-foreground text-base md:text-lg font-light leading-relaxed max-w-lg mx-auto">
            Receive our latest writings on design philosophy, material culture,
            and the art of spatial thinking — curated monthly.
          </p>
