...
// AboutIdentity Component — Editorial Origin Narrative
const AboutIdentity = () => {
  return (
    <section
      id="about-story"
        ...
        <div className="max-w-3xl mx-auto px-6 sm:px-8 relative">
          ...
          <div className="space-y-6 text-foreground/80 leading-[1.85] font-light text-[16.5px] sm:text-[17px]">
            ...
            <p className="first-letter:text-6xl first-letter:font-heading first-letter:font-bold first-letter:text-liminal-secondary first-letter:float-left first-letter:mr-3 first-letter:mt-1 first-letter:leading-[0.8]">
              ...
              conviction: that the spaces we inhabit are not passive backdrops
              to our lives — they are active participants in shaping how we
              think, feel, and connect. In 2024, our founding team came together
              in Dhaka with a shared vision — to create an interior design
              studio that would challenge the conventional and celebrate the
              extraordinary.
            </p>
            ...
            <p>
              ...
              represents the transformative space between what was and what
              could be. Every project we undertake exists in this threshold:
              between vision and reality, between art and function, between the
              architect and the inhabitant.
            </p>
            ...
            <p>
              ...
              space we have touched: the relentless pursuit of emotional truth
              in design. We don&apos;t chase trends. We study how light falls
