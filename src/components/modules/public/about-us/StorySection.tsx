        ...
        <div className="relative group pt-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center relative z-10">
            <div className="lg:col-span-6 relative">
              <div className="relative aspect-square lg:aspect-5/6 rounded-3xl overflow-hidden border border-border/40 shadow-2xl group/img">
                <Image
                  src="/assets/about-1.png"
                  alt="Our design studio"
                  fill
                  className="object-cover transition-transform duration-700 ease-out group-hover/img:scale-110 scale-[1.01] will-change-transform backface-hidden transform-gpu"
                />
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 rounded-full bg-white border border-border/40 shadow-xl flex flex-col items-center justify-center -rotate-12 group-hover:rotate-0 transition-transform duration-700">
                ...
                <span className="text-3xl font-bold font-heading text-liminal-secondary">
                  2012
                </span>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 space-y-10">
              ...
              <div className="space-y-6 text-muted-foreground text-lg leading-relaxed max-w-xl">
                <p>
                  ...
                  we&apos;ve evolved into a multi-disciplinary powerhouse, known
                  for our bold approach and meticulous attention to detail.
                </p>
                <p>
                  Our philosophy is simple: Innovation should never come at the
                  expense of comfort, and elegance is most powerful when it
                  remains functional. We work closely with our clients to ensure
                  every project is a unique reflection of their personality.
                </p>
              </div>
